...
always @(*) begin
    case (ImmSrc)
        ...
        3'b011: ImmExt = {{9{instr[15]}}, {instr[15:13], instr[12:9]}}; // B-type (branches)
        3'b100: ImmExt = {instr[15:3], 3'b000};                          // U-type (upper bits)
        3'b101: ImmExt = {instr[15:6], 6'b000000};                       // J-type (jump and link)
