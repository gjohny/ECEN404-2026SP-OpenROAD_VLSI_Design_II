...
module Sign_Extender(instr, ImmSrc, ImmExt);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  sky130_fd_sc_hd__a21bo_2 _09_ (
    .A1(ImmSrc[0]),
    .A2(instr[10]),
    .B1_N(_01_),
    .X(ImmExt[1])
  );
  sky130_fd_sc_hd__nor3b_2 _10_ (
    .A(ImmSrc[1]),
    .B(ImmSrc[0]),
    .C_N(instr[15]),
    .Y(_02_)
  );
  sky130_fd_sc_hd__a21o_2 _11_ (
    .A1(ImmSrc[0]),
    .A2(instr[11]),
    .B1(_02_),
    .X(ImmExt[2])
  );
  sky130_fd_sc_hd__a21o_2 _12_ (
    .A1(ImmSrc[0]),
    .A2(instr[12]),
    .B1(_02_),
    .X(ImmExt[3])
  );
  sky130_fd_sc_hd__a21o_2 _13_ (
    .A1(ImmSrc[0]),
    .A2(instr[13]),
    .B1(_02_),
    .X(ImmExt[4])
  ...
  sky130_fd_sc_hd__and3b_2 _23_ (
    .A_N(ImmSrc[0]),
    .B(instr[13]),
    .C(ImmSrc[1]),
    .X(_04_)
  );
  sky130_fd_sc_hd__a21o_2 _24_ (
    .A1(instr[15]),
    .A2(_03_),
    .B1(_04_),
    .X(ImmExt[13])
  );
  sky130_fd_sc_hd__and3b_2 _25_ (
    .A_N(ImmSrc[0]),
    .B(instr[14]),
    .C(ImmSrc[1]),
    .X(_05_)
